...
object HbaseTools extends Logging with Serializable {
  ...
  def loadHBaseData(sparkSession: SparkSession, conf: Configuration): DataFrame = {
    ...
    /**
     * def newAPIHadoopRDD[K, V, F <: org.apache.hadoop.mapreduce.InputFormat[K, V]](conf : org.apache.hadoop.conf.Configuration = { /* compiled code */ },
     * fClass : scala.Predef.Class[F], kClass : scala.Predef.Class[K], vClass : scala.Predef.Class[V]) :
